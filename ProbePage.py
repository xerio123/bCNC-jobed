...
class ProbeFrame(CNCRibbon.PageFrame):
	def __init__(self, master, app):
		...
		self.recsiz = tkExtra.FloatEntry(recframe(),width=4, background=tkExtra.GLOBAL_CONTROL_BACKGROUND)
	...
	#				width=48,
		...
		col += 1
		self.probeXdir = tkExtra.FloatEntry(lframe(),width=8, background=tkExtra.GLOBAL_CONTROL_BACKGROUND)
		...
		col += 1
		self.probeYdir = tkExtra.FloatEntry(lframe(),width=8, background=tkExtra.GLOBAL_CONTROL_BACKGROUND)
		...
		col += 1
		self.probeZdir = tkExtra.FloatEntry(lframe(),width=8, background=tkExtra.GLOBAL_CONTROL_BACKGROUND)
	...
	#				width=48,
		...
		Label(lframe(), text=_("Diameter:")).pack(side=LEFT)
		self.diameter = tkExtra.FloatEntry(lframe(), width=4, background=tkExtra.GLOBAL_CONTROL_BACKGROUND)
		self.diameter.pack(side=LEFT, expand=YES, fill=X)
		...
		col += 1
		self.x_orient = tkExtra.FloatEntry(lframe(),width=8, background=tkExtra.GLOBAL_CONTROL_BACKGROUND)
		...
		col += 1
		self.y_orient = tkExtra.FloatEntry(lframe(),width=8, background=tkExtra.GLOBAL_CONTROL_BACKGROUND)
		...
		col += 1
		self.xm_orient = tkExtra.FloatEntry(lframe(),width=8, background=tkExtra.GLOBAL_CONTROL_BACKGROUND)
		...
		col += 1
		self.ym_orient = tkExtra.FloatEntry(lframe(),width=8, background=tkExtra.GLOBAL_CONTROL_BACKGROUND)
...
class AutolevelFrame(CNCRibbon.PageFrame):
	def __init__(self, master, app):
		...
		lframe.pack(side=TOP, fill=NONE,expand=NO)
